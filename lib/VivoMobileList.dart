...
class VivoMobileList extends StatefulWidget {
  @override
  _VivoMobileListState createState() => _VivoMobileListState();
}

class _VivoMobileListState extends State<VivoMobileList> {
