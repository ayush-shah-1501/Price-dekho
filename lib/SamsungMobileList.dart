...
class SamsungMobileList extends StatefulWidget {
  @override
  _SamsungMobileListState createState() => _SamsungMobileListState();
}

class _SamsungMobileListState extends State<SamsungMobileList> {
