...
class OppoMobileList extends StatefulWidget {
  @override
  _OppoMobileListState createState() => _OppoMobileListState();
}

class _OppoMobileListState extends State<OppoMobileList> {
